...
G系列-----------------------------------------------------------------
通道数   单片(带定位)   单片(不带定位)      4片(带定位)    4片(不带定位)
8          2246           3102                  9023           12461
6          2606           3833                 10468           15396
4          3102           5012                 12461           20133
2          3833           7240                 15396           29080
1          4344           9308                 17449           37391

//固件版本说明----------------------------------------------------------------------------------
固件版本133以上，将在固件版本后缀增加功能标志识别，zz版本必须zz5.0及以上
固件版本分三部分：版本序号+芯片+功能标志
例如：固件版本： 133.S2B.P3GM2
...
180115  固件版本增加S3:M26模块识别，zz5.9及以上支持
...
v128  160824        FW同步时频率后从EE重新取频率后才显示；
                   ...
                   通道数不同，续传容量也会不同    2片      4片存储器全部焊上，扩容成4倍
                   带定位：
                   CH_NUM=8时，容量=2246                    9024
                   CH_NUM=6时，容量=2606
                   CH_NUM=4时，容量=3102
                   CH_NUM=2时，容量=3833           7688
                   CH_NUM=1时，容量=4344                    17452
                   ...
                   CH_NUM=4时，容量=5012                     
                   CH_NUM=2时，容量=7240
                   CH_NUM=1时，容量=9308                    37396


v129  160911        WIFI/GPRS 增加300.10+RTC 服务器时钟对时功能
v130  161010        WIFI,初始化06时，需要第4和第3，两个键同时按住3秒
      161026        记录仪，增加长按第三键，查看电量
v131  161108        L206 CIICR.GTPOS 检测是否掉线时间延长到20s
      161111        GPRS增加CGATT?检测， 解决GW不能打印问题
      161117        W卡片单机，每10分钟检测掉线后复位一次模块，掉线前5分钟复位一次模块
---------------------------------------------------------------------------------------------
v132  170104        门磁开关，增加对应显示，开门显示k, 关门不显示
v133  170111        电池检测，0-100% 对应 3.5-4.0
                    电池电压检测增加滤波
                    关机打印时不显示OFF
                    20,21,补传时显示上传标志，实时时不显示；报警开时显示小H,报警关时不显示
                    门磁开关，二号门，打印修正

      170209      K热电偶传感器，增加VT控制，不采样时，关闭电源
                    
                  L206模块对联通卡域名模式支持有问题,暂时改为IP模式。
                  L206升级后版本L206v01.01b11.01的新模块再做测试。
v134  170222      GPRS/变送器 开不了机，开机后显示01，不显示实时数据的问题
                  做了一个预防机制，如果检测无法进入实时数据界面的故障，复位，复位时蜂鸣器不再响
                  正在打印时，如果再次按打印键会自动退出打印
                  W95 W93 在连接异常时，主动复位一次模块电源

                  T95 兼容 MCGS触摸屏指令读取实时数据  01 03 01 40 

v135  170323      GPRS第一包补传取消2条限制
                  BSQ_RTC4_EN  T系列储存格式改用RTC(4),通讯格式仍然RTC(6)  这样一片512  T95-2  容量可达到8147  
                  
v136  170419      GPRS,双向通讯,T95,G95 超标红灯闪,
                 短信报警三个号码内容一致，断电报警，超标报警


      170516      ZX 24实时数据，上传间隔到，实时数据发送标志置1，模块优先发送实时数据

v137  170524      LCD20-电池电压检测，由3.5-4.0 调整到 3.58-4.05 
                 P5.2接一个LED,低电平开
                 投入式，开机时，按键短按切换报警开关，长按关机，关机时，短按开机
                 投入式，屏蔽正常模式
                 增加248短信指令设置
                 双向控制标志K读取，需zz5.5以上
                 GPRS接收后清空

v138  170607      GPRS每条发送后增加15ms延时，TCP_MAX设为500


                SMS_SET_EN
                 解析 字符中通道号为0时表面对所有通道操作
                (1)  C1L-2.3H126.7D 或  C2L2H8D 或  c2l2h8d  设置报警上下限
                (2)  C1AK 报警开  C1AG 报警关
                (3)  手机号码，XYZD格式解析
                      //CP3X15988458051Y18705769627Z15988458053D
                      //CP1X15988458051YZD
                      //CP0XYZD
                (4)  CT170517133500D  //设置时钟 (后期才有)

v139  170713     开放功能gn2标志
v140  170728     记录仪记录点开始兼容第一点记录，记录时间每30秒自动检查一次记录时间，手动开机延时时，不显示xOFF, 关机时，不显示GSM
      170817     变送器，支持RTU  T95-2
      170821     变送器，支持T95报警关时DX2不再发超标短信
      170908     修正USB W卡片接收机，匹配时 发送匹配信息
      171227     接收机去掉关机功能
     
//---------------------------------------------------------------------------------------------
      180118     2NTC增加通道号显示
      180124     wifi增加双向设置上下限
v141  180124     G52非整点记录模式，上次存储的时间比当前时间大了10分钟以上,说明时钟有误，立即开启新一轮记录
                 



******************************************************************************************/
//中断中和普通函数中共同使用的变量，要定义为 volatile
...
#define TB4_RTD_DELAY      2600//2300//70ms， max31865转换，必须要等70ms
#define TB4_RTD_START      TBCCTL4=CCIE;TBCCR4=TBR+TB4_RTD_DELAY;TBCTL=TBSSEL_1+MC_2
#define TB4_RTD_STOP       TBCCTL4&=~CCIE

#define TB4_KP_DELAY      190//6ms
#define TB4_KP_START      TBCCTL4=CCIE;TBCCR4=TBR+TB4_KP_DELAY;TBCTL=TBSSEL_1+MC_2
#define TB4_KP_STOP       TBCCTL4&=~CCIE
...
#define _1_PT_F40_120                  1371
#define _3_PT_F40_100                  1383
#define _5_4PT_0_300_1NTC              1385
#define _5_4PT_F100_200_1NTC           1395
#define _8_1PT_F100_200_7NTC           1408
#define _2_1PT_F100_200_1NTC           1402
...
#define _2_PT_F100_100                 1452
#define _4_PT_F100_100                 1454
#define _3_PT_F100_100_2NTC            1453
#define _3_PT_F100_100                 1463
#define _1_PT_F40_70                   1461
#define _4_PT_F100_100_3NTC            1464
#define _8_3PT_F100_100_5NTC           1468
#define _1_PT_F100_100                 1471
#define _1_PT_F200_200                 1481
...
#define _3RF_F200                      1573
#define _6RF_F200                      1586
#define _6RF_4NTC_2F200                1596
#define _7RF_5NTC_2F200                1597
...
#define _3_2NTC_1HIH                   2033//2NTC在13通道
#define _3_2_NTC_1HIH                  2043//2NTC在12通道
...
#define _8_7NTC_1HIH                   2188
#define _8_134678NTC_25HIH             2198

#define _1_HIH5030                     2301
#define _2_HIH5030                     2312
#define _4_HIH5030                     2314
...
#define _8_4PT_F40_100_4HIH            2518//4个PT在前4个
#define _4_2PT_F50_200_2HIH            2524
#define _4_1PT_F100_200_2NTC_1HIH      2534

#define _8_4PT_F100_200_4HIH           2548
#define _2_1PT_F200_100_1HIH           2552
#define _4_2PT_F40_100_2HIH            2554//PT在1和3
#define _4_2PT_F200_100_2HIH           2564//PT在1和3
#define _2_1PT_F50_200_1HIH            2572
#define _4_2PT_F100_200_2HIH           2574
#define _8_4PT_F100_300_4HIH           2578
...
#define _8_3NTC_3HIH5030_1HIH6130      2918
#define _2_NTC_HIH6130                 2922

//SHT30
#define _2_wdNTC_sdSHT30               2932
#define _2_wdSHT30_sdSHT30             2942
...
#define _3_NTC_HIH_TRSF                3193

#define _6_3NTC_3EC5                   3206//EC5  土壤水分的转换公式为 115.5V-51.2 (V的单位为：伏），这是在激发电压为3.3V的前提下校正的。
...
#define _2_O2_CO2_TTL_5000             4242


#define _3_WD_SD_CO2TTL10000           4253//10000ppm
#define _4_WD_SD_CO2TTL5000_GZ200K     4254//CO2  TTL数字信号
#define _6_WD_SD_CO2TTL5000_GZ200K_WD_TRSF    4256//CO2  TTL数字信号



#define _3_NTC_HIH_CO2TTL10BF          4263//有问题?
...
#define _8_NTC_HIH_CO2TTL5000_GZ200K_QY_NH3_H2S_CH4  4298//GPRS占用U0, 温度、湿度、CO2TTL、BH1750、SHR1000、NH3、H2S、CH4
                                                        //DCDC_ALL_EN 这个一直开着
                                                        //QY不要放在P2.5  P2.6，放在P5.1 P5.2
                                                        //滤波10
...
#define _6B_WD_SD_QY_YL01_FS_FX        5206//变送器模式,旧版本是1位小数，变送器雨量清0，固定1天清一次0
...
#define _7_WD_GZ200K_SD_YL01_FS_FX_TRWD 5287//变送器雨量，固定在0点清0，与记录仪不一样，
#define _8_WD_GZ200K_SD_YL01_FS_FX_TRWD_TRSF 5288
#define _5_2WD_2SD_GZ200K              5285



//水位.......水位+10滤波....需 AD_BIG_NULL_EN =1...............................................................
...
#define _2_WD_SW_1000_10mm             5432
#define _1_SW_0_2000mm                 5431



//计数系列............雨量做GPRS时需特别检查下0点清0..BSQ_YL_ENABLE.........................................................
#define _1_01YL                        5611
#define _1_02YL                        5621
#define _1_05YL                        5631
#define _1_CS                          5641
#define _3_NTC_HIH5030_01YL            5653//滤波10-4
#define _2_NTC_01YL                    5652
...
//散射辐射---------------------------------------------------------------------------
#define _1_SSFS_0_2000                 5731//散射辐射，0-20mV 需用运放放大100倍后，再采集
...
//输入触发.....................................................................
#define _3_CF                          6303//3路漏醋，任一路输入触发短信提醒，没触发0.0，触发100.0,报警范围设定(0,50) 

//库门开关
#define _1_DOOR                        6301//开关信号  开的时候报警
#define _1_SMOKE                       6311//烟感报警，常开，报警时闭合,  L 记录仪电池供电，升压至12v,一直供电，须 DCDC_ALL_EN =1 ， 触点接在5.0
...
//多普勒流速，485信号，主机发指令过去读 同时测量 流速,水深
#define _2_LS_SS                       7012//一路流速、水深
#define _4_2LS_2SS                     7014//二路流速、水深  成对


//=======================================================================================
#define JLY_MODEL                _4_2PT_F200_100_2HIH
//--------------------------------------------------------------------------------------
#define F248_EN                  1//配置的是248，需要在编译设置里修改配置，0为247

#define LG30_EN                  0//30车载板子
#define WK2124_EN                0//串口扩展

//---------------------------------------------------------------------------------------
#define DAC_EN                   0//DAC 95-2 4-20mA 输出

//----------------------------------------------------------------------------------------
//变送器、非GSP应用场合，超标变频2分钟记录,不必开启，比如气象、记录仪
#define GSP_ENABLE               1//变频要求，超标后，变频2分钟记录，(报警关时也这样)
#define GSP_BP_JIANGE            (120)//2分钟

//大屏7，中屏08，小屏20------------------------------------------------------------------------
#define LCD_NO                   7//7，8, 20  //08自动选择关屏 SD_ENABLE =1,除非 LCD08_ALL_ON =1
                                  //20,第二键长按清空数据，07，第一第二键同时长按清空数据

//-------------------------------20-----------------------------------------------------------
#define G_20_ENTER_EN            0//1为投入式(只有开关机键), 0为4个按键
#define BAT_FIL_EN               0//电池电压监测滤波

#define G_20_GZ_EN               0//20光照开箱检测, 代替开关门

//--------------------------------------------------------------------------------------------
#define JD_LED_EN                0//JD 电量<20 亮红灯，平时绿灯

//--------------------------------------------------------------------------------------------
#define LCD08_ALL_ON             0//LCD08在省电模式时不关屏
#define LCD07_SHUT_EN            0//LCD07在省电模式时关屏  20s
#define LCD08_SD_SHIFT_EN        0//只对08有效，cmd或key切换省电模式和正常模式,SD_ENABLE 必须开启，默认省电模式
...
//------------------------------------------------------------------------------------
#define P_VER                    0x98
#define C_VER                    141//大于9.8、9.9时，用z z2.4以上，识别C_VER 最大255
//-------------------------------------------------------------------------------------
#define BOOT_EN                  1//BOOT， 升级功能，APP区8000-F9FF, CH-CURVE区FA00-FBFF, BOOT区FC00-FFFF
//优化空间...主要针对GPRS-定位或打印的仪器空间不足的问题-------------------------------------
//-------------------------------------------------------------------------------------------
#define OPT_EN                   0//GPRS+GPS最省FLASH优化，去掉【adc lcd 2位小数和整数、uart】,PT调整不优化、光照等2位小数 和 整数 不优化， HW 不优化
#define OPT_AD_EN                0//AD调整模式优化, PT不优化0
//-------------------------------------------------------------------------------------
#define WDT_ENABLE               0//内部看门狗 zz
//-------------------------------------------------------------------------------------
#define DCDC_ALL_EN              0//DCDC电源一直开,没有省电模式
#define AD_BIG_NULL_EN           0//4-20mA输入，AD NULL 判断 600起
//-------------------------------------------------------------------------------------
...
#define PRINT_RT_ALL             0//记录一条，打印一条，全部通道, 前提：PRINT_RT_LIST_EN=1
#define PRINT_RT_LIST_BK_SD      0//记录一条，打印一条，包括通道2，湿度 ，前提：PRINT_RT_LIST_EN=1
#define PRINT_RT_LIST_BK_2WD     0//记录一条，打印一条，包括通道2，温度 ，前提：PRINT_RT_LIST_EN=1
...
//-------------------------------------------------------------------------------------------------
#define PRINT_NEW_EN             1//记录PRINT_NEW_CAP条数据,LOG和MAX键同时按住3秒清空打印缓冲, GPRS时 PRINT_NEW_EN 必须开启
#define RRINT_NEW_N_EN           1//打印最新数据N条使能

#define PRINT_ALL_CH_EN          0//打印全部通道，否则只有通道1
#define RPTINT_ONLY_WD_EN        0//打印全部温度，不打印湿度，只针对G95-2,3,4,6,8 和 G93-2,3,4（顺丰要求,打印格式为日期单独一行） _8_134678NTC_25HIH
#define PRINT_2WD_EN             0//打印温度1,温度2，现只支持G95-4,G95-6, G93-3,G93-2,G93-4(通道1通道2)
#define PRINT_1W1S_EN            0//打印温度1-湿度1
#define PRINT_4_EN               0//L95-62P打印前4通道
#define PRINT_1_3_EN             0//G93-4,打印通道1和3,必须PRINT_2WD_EN=1

//-----------------------------------------------------------------------------------------------------------
#define PRINT_FZ_EN              0//打印分组，G95-4P,每对温湿度一次,  打印键按1次打印第1组，连续按2次打印第2组
#define PRINT_FZ_WD_EN           0//只打印温度，不打印湿度


#define PRINT_INFOR_EN           0//增加SN，开始时间，结束时间，记录间隔，记录条数等信息
#define PRINT_MIN_MAX_EN         0//打印最大最小值

#define PRINT_NO_NULL_EN         0//通道1 NULL 不打印

#define RPINT_A_EN               0//打印结尾A：收货方，运单号，车牌号，收货人，交货人
#define RPINT_B_EN               0//打印结尾B：有效开始时间，有效结束时间，发货方 ，收货方
#define PRINT_C_EN               0//打印结尾C(秦骏): 打印日期，签名确认
#define PRINT_D_EN               0//打印结尾D：收货方，收货人，交货人
#define PRINT_E_EN               0//打印结尾E: 企业名称:设备名称:客户名称:品名:车牌名:驾驶员:收货人
...
#define PRINT_NEW_CAP            ((u16)1000)//打印缓冲容量,老版本不能超过3000,新版本30000默认最大容量
...
#define CMD_CTRL_EN              0//孔令武，485指令控制红外控制板和除湿器  RY_CONTROL_ENABLE=1
//------------------------------------------------------------------------------------------------------------
...
#define RY_CH2_AL_EN             0//通道2超标才开触发

//--------------------无线传感器--------------------------------------------------------------------------------
#define RF_CMD_MAX               21//FF版本，无线传感器最大字节 F0(1)+地址(1)+字节数x(1)+目标SN号(10)+电量W(1)+通道数N(1)+通道数值(2*N)+CRC16(2)
#define RF_CC_EN                 1//PP\CC版本，否则为FF版本

//---------------------------------------------------------------------------------------------
#define RF_PP_115200_EN          0//PP115200版本，必须 RF_CC_EN=1, 115200/8 b/s-> 14400/2  B/s  -> 7200 B/s  1B/0.14ms

//======================无线传感器或TTL传感器要接到U1切换============================================================================
#define RF_U1_EN                 0//U1到RF, LW,FW,NW.TW不需要，GW 或 LW-SMS 或GPRS+CO2TTL ,第二键切换U1到PC(显示08)或GW按下打印键，自动切换到PC,打印完成后，回到RF
...
#define RF_YQ_SS_EN              0//单机模式，扩充通道数

//----------------------多机-中继接收一体------------------------------------------------------
#define RF_MULTI_EN              0//多机，必须OPT_EN=0  必须配置成 _2_NTC_HIH5030,  堆栈设置成1000，完后设置回1200(非接收机配置)
...
//==========================无线卡片============================================================
/* 按键操作
1.设置地址：长按第2键，跳出数字，再短按第2键
2.查看地址：短按第1键
3.报警开关：短按第3键
4.设备关机：短按按键4，关机显示PPxx
5.设置频率：关机状态PPxx时，长按第2键，跳出数字，再短按第2键
6.HHHH状态：关机状态PPxx时，短按第1键
*/
#define RF_KP_EN                 0
#define RF_SEN_TIME              ((u16)10000)//60s,实际发送间隔大概 50-60  TB4_KP_DELAY=190,6ms
#define RF_RADOM_N               2000//11.6s
#define HHHH_TIME                240//HHHH超时自动退出

#if RF_KP_EN==1
#undef MIN_MAX_AVG_ENABLE
#define MIN_MAX_AVG_ENABLE       0//GPRS最大最小显示
#endif
...
//-----1/3定位 LBS  返回 经纬度  L206/M26----------------------------------------------------------------------
#define LBS_JWD_EN               0
#define L206_SLP_EN              0//省电时休眠，而不是关机
//-----1/3定位 LBS 返回 LAC+CID ------------------------------------------------------------------------
#define LBS_LAC_EN               0
#define GPRS_UP_ONE_EN           0//GPRS每包只上传一条， 赛翁用，其他不需要
...
#define D_RTC_TIME               3//超过，即自动对时

//------定位内置N10定位----------------------------------------------------------------------------------
#define SIM68_EN                 0//N10、SIM68定位，需GPS_MOUSE_EN ==1,RF_U1_EN ==1
#define SIM68_SLP_EN             0//休眠模式：正常模式时不休眠，省电模式时,GPS在收到正确定位数据后休眠，1分钟后唤醒，错误数据不休眠
...
//-------GSM-GPRS--------------------------------------------------------------------------------
//模块选择，默认 MG301
#define SIM800C_EN               1//SIM800C/L206, 否则为华为MG301
#define M26_EN                   0//M26 先设置SIM800C_EN=1

#define GSM_EM310_EN             0//EM310
#define GSM_MG323_EN             0//MG323 短信满后，无法再收短信，模块BUG, GPRS现在没有短信接收，所有可不考虑

#define MG323_GPRS_EN            0//发送完毕后重启模块

//---------------------------------------------------------------------------------------------
#define GSM_ENABLE               1
#define SMS_SAME_EN              1//短信一致性（3个号码）
#define SMS_POW_EN               1//断电短信, 09 20 没有断电检测

//-----------------------------------------------------------------------------------
#define SMS_TCP_EN               0//短信通过TCP包来发送，发送到短信平台：短信域名地址和端口 暂写死
#define SMS_RTC_EN               0//短信内容里包含时间

//-----------------------------------------------------------------------------------------
#define SMS_SEND_8H_EN           0//短信每8小时一次, 超标报警不发了。(每天6点，14点，22点)
#define SMS_SEND_6H_EN           0//短信每6小时一次，超标报警不发了。(0，6，12，18) SMS_SEND_8H_EN必须=1
#define SMS_SEND_6H2_EN          0//短信每6小时一次，超标报警不发了。(2，8，14，20) SMS_SEND_8H_EN必须=1
#define SMS_SEND_4H_EN           0//短信每4小时一次，超标报警不发了。(0，4，8，12,16,20) SMS_SEND_8H_EN必须=1
#define SMS_SEND_A_EN            0//短信每天 7,10,13,16,19,22,发送6次，SMS_SEND_8H_EN必须=1

//---------------------------------------------------------------------------------------
#define GSM_TXT_EN               0//英文格式，短信编码方式 TXT, 否则 PDU
//----------------------------------------------------------------------------------------
#define GPRS_SMS_CNMI_EN         0//GPRS 短信接收提示CNMI

//--------------------------------------------------------------------------------------
#define SMS_SET_EN               0//通过短信设置上下限和手机号码
#if F248_EN==1
    #undef SMS_SET_EN
    #define SMS_SET_EN           1//F248 自动开启短信接收处理
#endif
...
//-----------------------------------------------------------------------------------------
#define GPRS_AUTO_LIS_EN         0//测试天线信号时，打电话自动接听

//-------------------------------09.20.21有--------------------------------------------------------
#define BAT_LCD_EN               0//电量提示、保温箱GPRS、在A通道号处显示电池电量0-9 .通道数不能大于2
#define NO_EXPOW_EN              0//无外部电源检测------09GPRS板子无
...
#define GPRS_MEMS_EN             1//GPRS存储器自动检测多片,否则为单片

#define GPRS_6OFF                1//60FF，否则70FF,温度采集一直开，保温箱使用
#define GSM_D_TIME               20//掉线检测时间
...
//---------------------------------------------------------------------------------------------------
#define GPRS_FFEEDD_EN           0//哲勤协议，原路格LG31指令每包数据尾加 FF EE DD
...
#define TC_WAIT_T                20//25//每次重试发送数据间隔
...
#define PRINT_5_2_PER_EN         1//记录间隔1时，打印平时PRINT_SF_TIME分钟，超标2分

//-------------------------------记录间隔5或4--------------------------------------------------------
#define PRINT_52_42_EN           0//记录间隔5时，上一条超标2分钟后记录，上一条正常超标后立即记录，这样会出现12345间隔的数据
                                  //记录间隔4时，上一条超标2分钟后记录，上一条正常

//---------------------------------------------------------------------------------------------------
#define GPRS_UP_REAL_EN          0//37协议，刷新实时数据，上传时间到发送;   与 SMS_TCP_EN  同时使用37指令
...
//---------------------------------------------------------------------------------------------------------------
    ...
    #define TCP_MAX              ((u16)500)//一个TCP最大字节数  800 改到 500
#endif

//----------------------------------------------------------------------------------
#define ON_OFF_BJ_EN             1//开机标记、关机、上电、断电 记录，默认不打印
#define KJ_BJ                    0xFAFA
#define GJ_BJ                    0xFBFB
#define SD_BJ                    0xFDFD
#define DD_BJ                    0xFEFE
...
//----------------------------------------------------------------------------------
#define DOOR_PRINT_EN            0//门磁开关 打印使能


#define DOOR1_BJ_EN              0//一号门开关 记录
  #if G_20_GZ_EN==1
    #undef DOOR1_BJ_EN
    #define DOOR1_BJ_EN          1
  #endif
#define DOOR1_OPEN               0xF4F4//通道数值中用于替代温度数据  P5.0
#define DOOR1_CLOSE              0xF5F5

//2
#define DOOR2_BJ_EN              0//二号门开关  记录
#define DOOR2_OPEN               0xF6F6//通道数值中用于替代温度数据  P5.1
#define DOOR2_CLOSE              0xF7F7

//3 暂无
#define DOOR3_OPEN               0xF8F8//通道数值中用于替代温度数据  P5.2
#define DOOR3_CLOSE              0xF9F9

//---------------------------------------------------------------------------------
#define GPRS_UDP_EN              0//1为UDP，0为TCP

//--------------------------------------------------------------------------------------------------
#define BAT_TO_XH_EN             0//GPRS 上传信号，而不是电量
...
#define LG31_RECTIME_EN          1//LG31 协议中增加增加记录间隔和超标间隔 标志
#define TCP_SET_EN               1//回文设置300.10.B

//--------------------------------------------------------------------------------------------------
#define ZX_EN                    0//志翔协议，每次发送一条
#define CRC32_EN                 0//CRC32校验
...
//---------------------------------------------------------------------------------------------
#define BOOT_FROM_EE_EN          1//初始参数设置需对ee设置过才有,wifi记录间隔1分钟除外
...
//-------------------报警延时----------------------------------------------------------
#define SMS_IN_AL_EN             0//持续超标才短信报警
#define SG_IN_AL_EN              0//持续超标才声光报警
#define SMS_IN_AL_TIME           ((u16)60*10)
//-------------------------------------------------------------------------------------
//超标报警后，报警开关按键操作后继续执行后续短信报警操作，如果没有按过，不再短信报警--------------
#define ALARM_KEY_CONTINUE_EN    0//必须 SMS_IN_AL_EN=1 SG_IN_AL_EN=1



//..................超标报警LED闪烁.....................................................................
#define ALARM_LED_EN             0//超标报警时，LED闪烁  顺丰现在要求超标闪灯
//-------------------------------------------------------------------------------------------
...
#define FILET_NUM                12//去掉两头，只保留中间 FILET_MID 个求均值
#define FILET_MID                6
...
//.....................................................................................----...
#if G_20_ENTER_EN==1
  #define LCD_X_ENABLE           1//刷屏时间5
  #define LCD_X_TIME             4//2路刷屏时间
#else
...
#define LCD_REFRESH_TIME         ((u16)4)//采样间隔:秒 zz
...
//----------------------------------------------------------------------------------------------
#define RECORD_ENABLE            0//记录仪L模式，否则为变送器TFWG模式

//====================================================================================================
#if RECORD_ENABLE==1             //记录仪模式=========================================================
  #define L_Stime_First_EN       0//L记录仪第一个点包含启动时间，否则不包括
  #define L_REC_AVG_EN           0//记录的是每个间隔时间内的平均值
  #define L_REALOUT_PRINT_EN     0//485接口，L95-8P,,,10秒一次输出温湿度实时数据，按键打印历史数据

  #define L_LCD_BAT_EN           0//长按按键3显示电量, 只针对记录仪
  ...
  #define BSQ_T_AL_EN            1//T95 关报警时，DX2不再发该台超标短信

  #define ERR_RST_EN             1//采样故障检测.变送器，GPRS等(不包括无线GW，FW)

  #define BSQ_RTC4_EN            0//T95- RTC4字节记录模式，顺丰的设备，没有做多片储存，只是把记录时钟减少到4个字节

  #define BSQ_YIDA_EN            0//T95-对接易达系统，变送器协议
...
#if ((USB_ENABLE==1)||(LG30_EN==1))
  #define BAUDRATE_DOWNLOAD      115200//zz
...
//..............................................................................
#define ADC_CONSEQ_N             140//每次采样次数，求平均，可以滤掉波动 zz
...
#define ADC_PT_ERR_L             200//150//PT三线制，未接传感器时AD  zz
#define HIH5030_ERR              30//湿度错误判断 <30 认为为错误
...
//=================================================================================================
  ...
  #if GPRS_TC_EN==1
     #define EE_STATE_NUM_MAX       ((u16)400)//EE最后一组空间存放记录仪信息
  #else
     #define EE_STATE_NUM_MAX       ((u16)400+(PRINT_NEW_CAP*PRINT_CH_BYTE+4))//EE最后一组空间存放记录仪信息
  #endif

#elif RF_MULTI_EN==1//增加了100个卡片的实时缓存  必须  RF_SEN_MAX=100

  #define EE_STATE_NUM_MAX          ((u16)400+700)
...
#define PCBSQ_REC_CAP_FIRST    ((u32)STATE_FIRST_ADDR/ONE_SIZE)//记录容量，GPRS和打印一体, 第一片EE

#define PCBSQ_REC_CAP_EE2      ((u32)EE_MEM_ADDR/ONE_SIZE)//记录容量，第二片EE开始
...
#define PCBSQ_BAG_SIZE           ((u16)255)//数据包最大数(1字节<=255)
  ...
  #if RF_MULTI_EN==1
    #undef U0MAX
    #define U0MAX                    620//780
    #undef U1MAX
    #define U1MAX                    500//100->500
  #endif
  ...
  //USB 115200 速度快，包400，其他慢300
  #if BAUDRATE_DOWNLOAD==115200
...
//...........................................................................................
  ...
  ||(JLY_MODEL==_8_4NTC_4TRSF)||(JLY_MODEL==_4_NTC_HIH_NTC_TRSF)||(JLY_MODEL==_3_WD_TRSF_GZ200K)||(JLY_MODEL==_5_WD_TRSF_GZ200K_WD_SD)\
    ||(JLY_MODEL==_4_2NTC_2TRSF)||(JLY_MODEL==_4_TRSF)||(JLY_MODEL==_6_TRSF)||(JLY_MODEL==_5_TRSF)\
      ||(JLY_MODEL==_3_TRSF)||(JLY_MODEL==_5_4NTC_TRSF)||(JLY_MODEL==_2_TRSF)||(JLY_MODEL==_3_NTC_HIH_TRSF)\
    ...
    ||(JLY_MODEL==_1_CO2_2000PPM)||(JLY_MODEL==_1_CO2_5000PPM)||(JLY_MODEL==_2_CO2_2000_NTC)||(JLY_MODEL==_2_O2_CO2_TTL_5000)\
      ||(JLY_MODEL==_1_CO2_SOHATECH_3K)||(JLY_MODEL==_2_CO2_5000PPM)||(JLY_MODEL==_1_CO2_COZIR_W10V)\
        ...
        ||(JLY_MODEL==_1_SW_0_500mm)||(JLY_MODEL==_1_SW_0_1000mm)||(JLY_MODEL==_2_WD_SW_0_500mm)\
          ||(JLY_MODEL==_2_WD_SW_0_1000mm)||(JLY_MODEL==_2_WD_SW_500_10mm)||(JLY_MODEL==_1_SW_500_10mm)\
            ||(JLY_MODEL==_1_SW_0_50_m)||(JLY_MODEL==_1_SW_0_2000mm)||(JLY_MODEL==_2_WD_SW_0_3000mm)||(JLY_MODEL==_1_WD_SW_0_3000mm)\
              ||(JLY_MODEL==_1_SW_0_3000mm)||(JLY_MODEL==_1_SW_200_10mm)||(JLY_MODEL==_1_SW_1000_10mm)\
              ||(JLY_MODEL==_2_SW_30m_SHD_20m)||(JLY_MODEL==_2_WD_SW_1000_10mm)\
         ...
         ||(JLY_MODEL==_1_GH_400_10umol)||(JLY_MODEL==_3_WD_SD_GH400_10umol)\
          \
            ||(JLY_MODEL==_1_SDU_200_10mm)||(JLY_MODEL==_8_WD_GZ200K_SD_YL01_FS_FX_TRWD_TRSF)\
              ||(JLY_MODEL==_1_PM25_V_1000)||(JLY_MODEL==_2_PM25_TTL1000_PM25V_1000)\
                ||(JLY_MODEL==_2_PM25_TTL1000_CO2_MISIR_5000)\
           \
            ||(JLY_MODEL==_1_GZV_200K)||(JLY_MODEL==_3B_WD_GZ100K_TRSF)||(JLY_MODEL==_6_WD_SD_CO2TTL5000_GZ200K_WD_TRSF)\
              \
            ||(JLY_MODEL==_4_WD_SD_CO2_5000_GZ200K)||(JLY_MODEL==_4_WD_SD_CO2TTL5000_GZ200K)||(JLY_MODEL==_3_WD_SD_CO2TTL10000)\
              \
                   ...
                   ||(JLY_MODEL==_7_4NTC_2TRSF_1HIH)||(JLY_MODEL==_6_4NTC_1HIH_1TRSF)\
                     ||(DS18B20_SLP_EN==1)\
                       ||(JLY_MODEL==_4_TRWD_TRSF_TYFS_ZF)\
                         ||(JLY_MODEL==_1_ROTYONIC)||(JLY_MODEL==_6_3NTC_3EC5)\
          )
...
//U0接收传感器 TTL信号 
#if ((JLY_MODEL==_1_CO2_TTL_5000)||(JLY_MODEL==_4_WD_SD_CO2TTL5000_GZ200K)||(JLY_MODEL==_3_WD_SD_CO2TTL10000)||(JLY_MODEL==_1_CO2_TTL_20BF)||(JLY_MODEL==_3_NTC_HIH_CO2TTL10BF)\
  ||(JLY_MODEL==_5_WD_SD_WD_GZ200K_CO2TTL5000)||(JLY_MODEL==_3_NTC_HIH_CO2TTL20BF)||(JLY_MODEL==_7_WD_SD_WD_GZ200K_CO2TTL5000_2WD)\
    ||(JLY_MODEL==_8_NTC_HIH_CO2TTL5000_GZ200K_QY_NH3_H2S_CH4)||(JLY_MODEL==_2_O2_CO2_TTL_5000)||(JLY_MODEL==_6_WD_SD_CO2TTL5000_GZ200K_WD_TRSF))
  #define SEN_UART_EN         1//UART接收，TTL数字传感器，比如GSS CO2  输出  Z 00777 z 00777
  #define CO2_GSS_TTL_EN      1//数据接收，按钮调零

#if ((JLY_MODEL==_1_CO2_TTL_20BF)||(JLY_MODEL==_3_NTC_HIH_CO2TTL20BF)||(JLY_MODEL==_3_NTC_HIH_CO2TTL10BF))//TTL 20% ，调零X 42 ,  输出值需x10
...
#if ((JLY_MODEL==_2_LS_SS)||(JLY_MODEL==_4_2LS_2SS))
  #define SEN_MODBUS_485_EN   1//485接口 读 多普勒流速 水深
#else
  #define SEN_MODBUS_485_EN   0
#endif
...
//...............................................................................
#if ((JLY_MODEL==_2_FS_FX)||(JLY_MODEL==_6_WD_GZ100K_SD_YL01_FS_FX)||(JLY_MODEL==_4_WD_SD_FS_FX)\
...
////变送器雨量清0，固定1天清一次0，，放在BSQ_ENABLE配置后面..........................................................................................
#if ((JLY_MODEL==_1_01YL)||(JLY_MODEL==_1_02YL)||(JLY_MODEL==_1_05YL)||(JLY_MODEL==_1_CS))
   #define ONLY_JS_ENABLE     1//单独计数

   #if BSQ_ENABLE==1

       #define BSQ_YL_ENABLE   1 
       #define YL_CH           0//雨量通道位置 
       ...
       #define BSQ_YL_ENABLE    1 
       #define YL_CH            1 //StateC.Value[1]=Pt.RainPt=0;

   #endif


#elif ((JLY_MODEL==_8B_WD_GZ100K_SD_YL01_TRWD_TRSF_FS_FX)||(JLY_MODEL==_8B_WD_GZV200K_SD_YL01_TRWD_TRSF_FS_FX)\
      ||(JLY_MODEL==_6B_WD_SD_QY_YL01_FS_FX)||(JLY_MODEL==_6_WD_SD_QY_YL01_FS_FX)||(JLY_MODEL==_7_WD_GZ200K_SD_YL01_FS_FX_TRWD)\
        ||(JLY_MODEL==_8_WD_GZ200K_SD_YL01_FS_FX_TRWD_TRSF))

   #if BSQ_ENABLE==1

       #define BSQ_YL_ENABLE    1 
       #define YL_CH            3 // 变送器雨量固定在通道4，StateC.Value[3]=Pt.RainPt=0;
...
//..............................................................................
#if ((G_20_GZ_EN==1)||\
   ((JLY_MODEL==_3_WD_SD_GZ100K)||(JLY_MODEL==_3_WD_SD_GZ200K)||(JLY_MODEL==_5_WD_TRSF_GZ200K_WD_SD)\
  ...
  ||(JLY_MODEL==_6_WD_GZ100K_SD_YL01_FS_FX)||(JLY_MODEL==_6_WD_GZ100K_SD_YL05_FS_FX)\
    ||(JLY_MODEL==_8_WD_GZ100K_SD_YL01_TRWD_TRSF_FS_FX)||(JLY_MODEL==_1_GZ_65K)||(JLY_MODEL==_6_2NTC_2HIH_2GZ100K)\
      ||(JLY_MODEL==_8B_WD_GZ100K_SD_YL01_TRWD_TRSF_FS_FX)||(JLY_MODEL==_2_WD_GZ200K)||(JLY_MODEL==_5_2WD_2SD_GZ200K)\
        ||(JLY_MODEL==_4_WD_SD_CO2_5000_GZ200K)||(JLY_MODEL==_4_WD_GZ100K_SD_YL01)||(JLY_MODEL==_4_WD_SD_CO2TTL5000_GZ200K)\
          ||(JLY_MODEL==_5_WD_GZ100K_TRWD_TRSF_SD)||(JLY_MODEL==_7_WD_GZ100K_TRWD_TRSF_SD_YL01_QY)||(JLY_MODEL==_6_WD_SD_CO2TTL5000_GZ200K_WD_TRSF)\
...
//..............................................................................
  ...
  ||(JLY_MODEL==_4_2NTC_2HIH5030)||(JLY_MODEL==_6_3NTC_3TRSF)||(JLY_MODEL==_6_3NTC_3EC5)||(JLY_MODEL==_8_4NTC_4TRSF)\
    ||(JLY_MODEL==_4_2NTC_2TRSF)||(JLY_MODEL==_8_4WD_0_80_4SD_0_100)||(JLY_MODEL==_4_2PT_F50_200_2HIH)||(JLY_MODEL==_4_2PT_F200_100_2HIH)\
      ||(JLY_MODEL==_6_2PT_2ROTYONIC_NTC_HIH)||(JLY_MODEL==_4_2PTH_2HIH)||(JLY_MODEL==_4_2PT_F50_100_2HIH)\
        ||(JLY_MODEL==_4_2PT_F40_100_2HIH)||(JLY_MODEL==_4_2PT_F100_200_2HIH)||(JLY_MODEL==_4_2LS_2SS)||(JLY_MODEL==_8_3NTC_3HIH5030_1HIH6130))
...
//............................................................................
...
#if ((JLY_MODEL==_1_CO2_2000PPM)||(JLY_MODEL==_1_CO2_5000PPM)||(JLY_MODEL==_2_CO2_2000_NTC)||(JLY_MODEL==_1_SSFS_0_2000)\
   ||(JLY_MODEL==_1_CO2_SOHATECH_3K)||(JLY_MODEL==_1_YALI_160_10kpa)||(JLY_MODEL==_2_CO2_5000PPM)||(JLY_MODEL==_3_WD_SD_CO2TTL10000)\
   ||(JLY_MODEL==_1_DY_500_10mv)||(JLY_MODEL==_1_GH_400_10umol)||(JLY_MODEL==_3_WD_SD_GH400_10umol)\
     ||(JLY_MODEL==_1_SDU_200_10mm)||(JLY_MODEL==_4_WD_SD_CO2_5000_GZ200K)||(JLY_MODEL==_4_WD_SD_CO2TTL5000_GZ200K)\
       ||(JLY_MODEL==_6_WD_SD_CO2TTL5000_GZ200K_WD_TRSF)\
       ||(JLY_MODEL==_2_WD_SW_500_10mm)||(JLY_MODEL==_1_SW_500_10mm)||(JLY_MODEL==_2_CO2_5000PPM_SD)||(JLY_MODEL==_1_SW_200_10mm)\
         ||(JLY_MODEL==_2_YALI_160_10kpa_PTH)||(JLY_MODEL==_2_CO2_5000PPM_O2)||(JLY_MODEL==_3_NTC_HIH_CO2_5000PPM)\
           ||(JLY_MODEL==_1_CO2_Z14_5000)||(JLY_MODEL==_2_CO2_Z14_5000)||(JLY_MODEL==_1_CO2_TTL_5000)||(JLY_MODEL==_1_SW_1000_10mm)\
             ||(JLY_MODEL==_5_2NTC_2HIH_CO2_Z14_5000)||(JLY_MODEL==_7_3NTC_3HIH_CO2_Z14_5000)||(JLY_MODEL==_2_FS_FX)||(JLY_MODEL==_3_FS_FX_01YL)||(JLY_MODEL==_4_WD_SD_FS_FX)\
               ||(JLY_MODEL==_1_CO2_MISIR_5000)||(JLY_MODEL==_5_2NTC_2HIH_CO2_MISIR_5000)||(JLY_MODEL==_7_3NTC_3HIH_CO2_MISIR_5000)\
                 ||(JLY_MODEL==_1_CO2_MK400_2000)||(JLY_MODEL==_6_WD_SD_QY_YL01_FS_FX)||(JLY_MODEL==_5_WD_SD_WD_GZ200K_CO2TTL5000)\
                   ||(JLY_MODEL==_7_WD_SD_WD_GZ200K_CO2TTL5000_2WD)||(JLY_MODEL==_8_NTC_HIH_CO2TTL5000_GZ200K_QY_NH3_H2S_CH4)||(JLY_MODEL==_2_O2_CO2_TTL_5000)\
                     ||(JLY_MODEL==_7_WD_GZ200K_SD_YL01_FS_FX_TRWD)||(JLY_MODEL==_8_WD_GZ200K_SD_YL01_FS_FX_TRWD_TRSF)||(JLY_MODEL==_2_WD_SW_1000_10mm))
  ...
  #define U_x10_ENABLE     0
         ...
         ||(JLY_MODEL==_3_PT_0_300)||(JLY_MODEL==_4_PT_0_300)||(JLY_MODEL==_2_PT_F100_200_PH)\
          ...
          ||(JLY_MODEL==_3_PT_F100_200)||(JLY_MODEL==_4_PT_F100_200)||(JLY_MODEL==_1_PT_F40_70)\
            ||(JLY_MODEL==_4_PT_F50_300)||(JLY_MODEL==_4_PT_F40_100)||(JLY_MODEL==_3_PT_F40_100)\
              ||(JLY_MODEL==_1_PT_F40_100)||(JLY_MODEL==_1_PT_F40_250)||(JLY_MODEL==_4_PT_F100_100)||(JLY_MODEL==_3_PT_F100_100)\
                ||(JLY_MODEL==_1_PT_F200_100)||(JLY_MODEL==_1_PT_F20_120)||(JLY_MODEL==_1_PT_F40_120)\
                  ||(JLY_MODEL==_1_PT_0_200)||(JLY_MODEL==_2_PT_F40_100)||(JLY_MODEL==_4_PT_F50_200)\
                    ||(JLY_MODEL==_3_PT_F50_250)||(JLY_MODEL==_1_DZ_0_60_R)||(JLY_MODEL==_2_PT_F100_100)||(JLY_MODEL==_1_PT_F100_100)\
                      ||(JLY_MODEL==_3_PT_F50_300)||(JLY_MODEL==_1_PT_F50_300)||(JLY_MODEL==_4_PT_F200_100)\
                        ||(JLY_MODEL==_4_PT_F150_150)||(JLY_MODEL==_2_PT_F200_100)||(JLY_MODEL==_2_PT_F50_250)\
                          ||(JLY_MODEL==_3_PT_F200_100)||(JLY_MODEL==_4_PT_F50_250)||(JLY_MODEL==_4_PT_F50_150)||(JLY_MODEL==_1_PT_F200_200))
  ...
  ||(JLY_MODEL==_3_WD_SD_QY)||(JLY_MODEL==_6_WD_SD_QY_YL01_FS_FX)||(JLY_MODEL==_8_NTC_HIH_CO2TTL5000_GZ200K_QY_NH3_H2S_CH4))
...
#if ((JLY_MODEL==_2_WDHTU_SDHTU)||(JLY_MODEL==_2_WDHIH6130_SDHIH6130)||(JLY_MODEL==_8_3NTC_3HIH5030_1HIH6130)||(JLY_MODEL==_2_NTC_HIH6130)||(JLY_MODEL==_2_wdNTC_sdSHT30)\
  ||(JLY_MODEL==_2_wdSHT30_sdSHT30))
  #define HTU_ENABLE                1
#else
  #define HTU_ENABLE                0
#endif
...
#define CMD_SET_RF_KP            0x32//设置接收机指令
#define CMD_READ_RF_KP           0x33//读取接收机指令

#define CMD_SET_CD               0x34//设置测点参数
#define CMD_READ_CD              0x35//读出测点参数
...
#define _T_LS     0x20//流速
#define _T_SS     0x21//水深

#define _T_SSFS   0x22//散射辐射
...
#define LD_GRN_ON          P5DIR|=BIT3;P5OUT&=~BIT3
#define LD_GRN_OFF         P5DIR|=BIT3;P5OUT|=BIT3

#define LD_RED_ON          P5DIR|=BIT2;P5OUT&=~BIT2
#define LD_RED_OFF         P5DIR|=BIT2;P5OUT|=BIT2

#define LD_ST_ON           P5DIR|=BIT1;P5OUT&=~BIT1
#define LD_ST_OFF          P5DIR|=BIT1;P5OUT|=BIT1 
...
#elif ((RY_CONTROL_ENABLE==1)||(RY_GSM_ENABLE==1)||(RY_ALARM_EN==1)||(RY_CH2_AL_EN==1))//继电器电源
#define DCDC_ON            NOP
#define DCDC_OFF           NOP
#define LED12V_AL_ON       NOP
#define LED12V_AL_OFF      NOP
...
#elif JD_LED_EN==1
#define LED_OFF            LD_GRN_OFF;LD_RED_OFF;LD_ST_OFF;
#define LED_ON             NOP
...
#else
#define GSMRST_L           P3DIR|=BIT1;P3OUT&=~BIT1
#define GSMRST_H           P3DIR|=BIT1;P3OUT|=BIT1
...
#define CLR_KEY_1_INT     P1IE&=~KEY_1_BIT;
    ...
    #define SET_KEY_2_INT     NOP
    #define CLR_KEY_2_INT     NOP
    
    #define KEY_3_BIT         BIT6
    #define SET_KEY_3_INT     NOP
    #define CLR_KEY_3_INT     NOP
    
    #define KEY_4_BIT         BIT7
    #define SET_KEY_4_INT     NOP
    #define CLR_KEY_4_INT     NOP
...
#if ((USB_ENABLE==1)&&(RF_REC_EN==0))//无线接收时，不休眠
...
#if ((LCD_NO==20)&&(G_20_ENTER_EN==0))//新款保温箱设备，带背光
  #define BG_LED_ON        P4DIR|=BIT2;P4OUT|=BIT2
  #define BG_LED_OFF       P4DIR|=BIT2;P4OUT&=~BIT2
#endif
...
//GSM  DTR  
#if L206_SLP_EN==1
    #define DTR_H    P4DIR|=BIT3;P4OUT&=~BIT3
    #define DTR_L    P4DIR|=BIT3;P4OUT|=BIT3
#endif
...
//============eeprom====================================================================================
//工作参数=372+(4+PRINT_NEW_CAP*PRINT_CH_BYTE),不能超过总空间(EE_STATE_NUM_MAX).....................
//(1)仪器工作时可变量A1(6)
...
//卡片数(1)
#define RF_N_ADDR                ((u16)PRINT_DUEOUT_ADDR+2)//1
//记录间隔(2)分钟
#define RF_REC_T_ADDR            ((u16)RF_N_ADDR+1)//2

//RF超时时间(2)
#define RF_T_OUT_ADDR            ((u16)RF_REC_T_ADDR+2)//2

//zx测点信息(10) 
#define GPRS_ZXCH_ADDR            ((u16)RF_T_OUT_ADDR+2)//1 层号
#define GPRS_ZXADR_ADDR           ((u16)GPRS_ZXCH_ADDR+1)//1 地址
#define GPRS_ZXKK_ADDR            ((u16)GPRS_ZXADR_ADDR+1)//1 空库
#define GPRS_ZXQYH_ADDR           ((u16)GPRS_ZXKK_ADDR+1)//6 企业号
#define GPRS_ZXKH_ADDR            ((u16)GPRS_ZXQYH_ADDR+6)//1 库号


//LCD08省电模式与正常模式切换(1)
#define LCD08_SHIFT_EN_ADDR      ((u16)GPRS_ZXKH_ADDR+1)//1

//卡片SN(2)
#define RF_SN_ADDR               ((u16)LCD08_SHIFT_EN_ADDR+1)//2

//频率(1)
#define RF_FZ_ADDR               ((u16)RF_SN_ADDR+2)//1
...
//上一条记录时间点(4)，是否超标标记(1)
#define BC_SS_ADDR               ((u16)PRINT_XX_5_ADDR+2)//4
#define BC_AL_ADDR               ((u16)BC_SS_ADDR+4)//1

//短信标题(20)
#define SMS_TITLE_ADDR           ((u16)BC_AL_ADDR+1)//20
...
#elif RF_MULTI_EN==1
    #define RF_REAL_S_ADDR               ((u16)SMS_TITLE_ADDR+20)//700, 最多可缓存100个卡片
...
typedef struct{  
  #if L_REC_AVG_EN==1
  long LRmum[CH_NUM];//累加和，求平均值用           long 为有符号数
  u32 LRYouxiaoNum[CH_NUM];//累加时，剔除NULL时的有效个数
  u16 LRavg[CH_NUM];
  #endif
  ...
  #if SMS_SAME_EN==1
  volatile u16 SmsValue[8];//数值
  volatile u8 SmsVBit;//正负号
  volatile u8 SmsChAFlag;//通道超标报警标志
  #endif
  ...
  #elif ((PRINT_RT_LIST_EN==1)||(CMD_CTRL_EN==1))
  u8 PcLinkPt;//正在于PC连接时
  
  #elif ((SEN_MODBUS_485_EN==1)||(L_REALOUT_PRINT_EN==1))
  vu8 sending;
  vu8 PcLinkPt;//正在于PC连接时
  u8 senct;//每2秒发送一次
  u8 sen_refg;
  u8 sen_2;//2个传感器切换发送指令
  #endif
  ...
  u16 FilterAd[8][FILET_NUM];//8路  zz
  u8 FiletPt[8];//数组指针
  u8 FiletNt[8];//次数
  #endif
  ...
  u32 LBS_JdDec;//经度小数部分
  u32 LBS_WdDec;//纬度小数部分
  u8 LBS_JdInt;//经度整数部分
  u8 LBS_WdInt;//纬度整数部分
  #endif
  ...
  #if ((SEN_UART_EN==1)||(SEN_U0_PM25_EN==1)||(SEN_MODBUS_485_EN==1))
...
typedef struct{
  ...
  u8 ID[5];//SN 十六进制
  vu16 XlhPt;//包序列号，发送成功后，序号从0开始到65535，一直循环，什么时候主动清0？
...
typedef struct{
  ...
  #define CNI_INT   CPIN+1
  #define CMGF      CNI_INT+1
  ...
  #define CREG       CSQ+1
  #define L_CGREG    CREG+1//zz
  
  u8 GtposPt;
  
  #if M26_EN==1
      #define L_GTPOS     L_CGREG+1//取定位
  #else 
      
      #define L_CGATT    L_CGREG+1
      
      //开始取经纬度
      #define L_CIPSHUT   L_CGATT+1
      #define L_CIPMODE   L_CIPSHUT+1
      
      #define L_COPS      L_CIPMODE+1
      #define L_CSTT      L_COPS+1
      #define L_CIICR     L_CSTT+1
      #define L_GTPOS     L_CIICR+1
      
  #endif
  
  #define T_CSQ         L_GTPOS+1
  ...
  #define T_CSQ      CREG+1
      ...
      #define TC_CGREG          T_CSQ+1
      
      #if SIM800C_EN==1
  
          #if LBS_JWD_EN==0
            #define TC_CGATT    TC_CGREG+1
            #define TC_CIPSHUT  TC_CGATT+1//AT+QIDEACT
          #else
            #define TC_CIPSHUT  TC_CGREG+1
          #endif
  
          #if M26_EN==1
            #define TC_QIDNSIP  TC_CIPSHUT+1
            #define TC_CIPMUX   TC_QIDNSIP+1//AT+QIMUX=0
          #else
            #define TC_CIPMUX   TC_CIPSHUT+1//AT+QIMUX=0
          #endif
  
  
          #define TC_CIPMODE    TC_CIPMUX+1//AT+QIMODE=1
          #define TC_CIPCCFG    TC_CIPMODE+1//AT+QITCFG=3,10,1400,1
  
  
  
          #if LBS_JWD_EN==1
  
              #if M26_EN==1//M26这3步捆绑设置  QIREGAPP   QIACT  QILOCIP
                #define TC_COPS       TC_CIPCCFG+1
                #define TC_CSTT       TC_COPS+1//AT+QIREGAPP="CMNET" 
                #define TC_CIICR      TC_CSTT+1//AT+QIACT  激活场景
              #else
                #define TC_CIICR      TC_CIPCCFG+1
              #endif
              ...
              #define TC_COPS       TC_CIPCCFG+1
              #define TC_CSTT       TC_COPS+1//AT+QIREGAPP="CMNET" 
              #define TC_CIICR      TC_CSTT+1//AT+QIACT
  
          #endif
  
  
          #define TC_CIFSR      TC_CIICR+1//AT+QILOCIP
          ...
          #define ATW           TC_CIFSR+1
              ...
              #define M_CGATT    TC_CGREG+1
              #define COPS       M_CGATT+1
  ...
  #if SMS_TCP_EN==1
  u8 SIM_CCID[20];//SIM卡的CCID号
  u8 SIM_IMSI[15];//SIM卡的IMSI号
  u8 G_IMEI[15];//IMEI,设备
  u8 SmsAL;// 1 超标报警  0 无
  u8 SmsPow;// 1 断电或 2 上电 0无
  u8 smsPort;//当前端口
  u8 smsErrPt;//连续5次发送失败，不再发短信
  
  vu16 SmsPowLen;
  u8 SmsPowUni[200];//电源短信内容,与SmsRecUni放超标内容分开
  ...
  u8 ToOff:1;//关机，如果在透传时，先退出透传，再关机
    ...
    //非透传数据传输模式
          ...
          #if GPRS_TC_EN==0
              //MG323每次连接时，如果上步已经断开连接，则连不上，必须重走一遍(MG301 不需要)
  
             //^SIS: 255, 0, 60, IP bearer link(0) has been cleared  //这个之后需重新连接配置
               
              u8 FgSISW:1;//因为MG301, SISO连接时，会返回2次OK或SISW，故通过这个变量滤掉一次
              
              #define G_CGATT    1
              #define COPS       G_CGATT+1
              #define IOMODE     COPS+1
              #define SICS1      IOMODE+1
              #define SICS2      SICS1+1
              #define SISS1      SICS2+1
...
#if ((PT_MAX31865_EN==1)||(K_MAX31855_EN==1))
  u8 t_pt[CH_NUM];
  int t_temp[CH_NUM];
#endif  
...
#if WIRELESS_ENABLE==1
  #define W_DOG_TIME  ((u16)60*25)
  u16 Wdog;//W正常连接时间，异常则复位模块
#endif
...
#define LED_TIME         10
  ...
  #define REAL_DOG_TIME  30
  u8 RealDog;//实时数据是否正常检测
...
#if RF_YQ_SS_EN==1
  u8 GprsRePt;//每次上传，重复次数=通道数，即可把所有通道发送完
#endif
